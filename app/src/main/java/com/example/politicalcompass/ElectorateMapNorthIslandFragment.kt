...
class ElectorateMapNorthIslandFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.electorate_map_two, container, false);
        val richPathView: RichPathView =
            view.findViewById(R.id.north_island_map) //findViewById<RichPathView>(R.id.north_island_map)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            ElectorateMapNorthIslandFragment().apply {
